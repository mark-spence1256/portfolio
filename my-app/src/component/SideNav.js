...
import { faLinkedinL,faGithub,faPhone, } from '@fortawesome/free-solid-svg-icons';

export const SideNav = () => {
    return (
        <div>
           <ul className="sidenav">
       <li><a href="https://www.linkedin.com/in/mark-spence-7a900617a/"><FontAwesomeIcon icon={{faLinkedinL}} style={{color:'red'}}/></a></li>
